...
class plgVmPaymentPayu_easyplus extends vmPSPlugin
{
    ...
    public function _processStatus(&$mb_data, $vmorder, $method)
    {
    ...
    public function _getPaymentResponseHtml($paymentTable, $payment_name)
    {
    ...
    public function _storeInternalData($method, $mb_data, $virtuemart_order_id)
    {
    ...
    public function plgVmConfirmedOrder($cart, $order)
    {
        ...
        $payuInterface = $this->loadPayUInterface($method);
    ...
    public function plgVmOnPaymentResponseReceived(&$html)
    {
        ...
        if ($virtuemart_order_id) {
            ...
            $payuInterface = $this->loadPayUInterface($method, $this);
            $payuInterface->setOrder($order);
    ...
    public function plgVmOnPaymentNotification()
    {
        ...
        $this->logInfo(print_r($mb_data), 'message');
    }
    ...
    private function loadPayUInterface($method)
    {
